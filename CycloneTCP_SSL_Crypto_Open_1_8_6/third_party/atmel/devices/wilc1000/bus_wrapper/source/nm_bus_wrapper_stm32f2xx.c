/**
 * @file nm_bus_wrapper_stm32f2xx.c
 * @brief SPI bus wrapper for STM32F2xx microcontrollers
 *
 * @section License
 *
...
sint8 nm_bus_init(void *pvinit)
{
   ...
   GPIO_PinAFConfig(CONF_WILC_SCK_GPIO,
      CONF_WILC_SCK_PIN_SOURCE, CONF_WILC_SPI_GPIO_AF);
   ...
   GPIO_PinAFConfig(CONF_WILC_MOSI_GPIO,
      CONF_WILC_MOSI_PIN_SOURCE, CONF_WILC_SPI_GPIO_AF);
   ...
   GPIO_PinAFConfig(CONF_WILC_MISO_GPIO,
      CONF_WILC_MISO_PIN_SOURCE, CONF_WILC_SPI_GPIO_AF);
