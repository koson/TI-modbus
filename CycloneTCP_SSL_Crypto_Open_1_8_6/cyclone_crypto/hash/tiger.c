...
//Tiger object identifier (1.3.6.1.4.1.11591.12.2)
static const uint8_t tigerOid[] = {0x2B, 0x06, 0x01, 0x04, 0x01, 0xDA, 0x47, 0x0C, 0x02};
...
/**
 * @brief Digest a message using Tiger
...
/**
 * @brief Initialize Tiger message digest context
 * @param[in] context Pointer to the Tiger context to initialize
 **/

void tigerInit(TigerContext *context)
{
   //Set initial hash value
   context->h[0] = 0x0123456789ABCDEF;
   context->h[1] = 0xFEDCBA9876543210;
   context->h[2] = 0xF096A5B4C3B2E187;
...
/**
 * @brief Update the Tiger context with a portion of the message being hashed
...
void tigerProcessBlock(TigerContext *context)
{
   ...
   //Each 512-bit message block is divided into eight 64-bit words
   ...
   context->h[0] = a ^ context->h[0];
   context->h[1] = b - context->h[1];
   context->h[2] = c + context->h[2];
}
