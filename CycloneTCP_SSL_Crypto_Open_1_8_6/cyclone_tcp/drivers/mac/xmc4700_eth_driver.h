...
#define _XMC4700_ETH_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef XMC4700_ETH_TX_BUFFER_COUNT
   #define XMC4700_ETH_TX_BUFFER_COUNT 3
#elif (XMC4700_ETH_TX_BUFFER_COUNT < 1)
   #error XMC4700_ETH_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef XMC4700_ETH_TX_BUFFER_SIZE
   #define XMC4700_ETH_TX_BUFFER_SIZE 1536
#elif (XMC4700_ETH_TX_BUFFER_SIZE != 1536)
   #error XMC4700_ETH_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef XMC4700_ETH_RX_BUFFER_COUNT
   #define XMC4700_ETH_RX_BUFFER_COUNT 6
#elif (XMC4700_ETH_RX_BUFFER_COUNT < 1)
   #error XMC4700_ETH_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef XMC4700_ETH_RX_BUFFER_SIZE
   #define XMC4700_ETH_RX_BUFFER_SIZE 1536
#elif (XMC4700_ETH_RX_BUFFER_SIZE != 1536)
   #error XMC4700_ETH_RX_BUFFER_SIZE parameter is not valid
#endif

//Interrupt priority grouping
#ifndef XMC4700_ETH_IRQ_PRIORITY_GROUPING
   #define XMC4700_ETH_IRQ_PRIORITY_GROUPING 1
#elif (XMC4700_ETH_IRQ_PRIORITY_GROUPING < 0)
   #error XMC4700_ETH_IRQ_PRIORITY_GROUPING parameter is not valid
#endif

//Ethernet interrupt group priority
#ifndef XMC4700_ETH_IRQ_GROUP_PRIORITY
   #define XMC4700_ETH_IRQ_GROUP_PRIORITY 48
#elif (XMC4700_ETH_IRQ_GROUP_PRIORITY < 0)
   #error XMC4700_ETH_IRQ_GROUP_PRIORITY parameter is not valid
#endif

//Ethernet interrupt subpriority
#ifndef XMC4700_ETH_IRQ_SUB_PRIORITY
   #define XMC4700_ETH_IRQ_SUB_PRIORITY 0
#elif (XMC4700_ETH_IRQ_SUB_PRIORITY < 0)
   #error XMC4700_ETH_IRQ_SUB_PRIORITY parameter is not valid
#endif
...
extern const NicDriver xmc4700EthDriver;

//XMC4700 Ethernet MAC related functions
