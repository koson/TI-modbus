...
#define _LPC175X_ETH_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef LPC175X_ETH_TX_BUFFER_COUNT
   #define LPC175X_ETH_TX_BUFFER_COUNT 2
#elif (LPC175X_ETH_TX_BUFFER_COUNT < 1)
   #error LPC175X_ETH_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef LPC175X_ETH_TX_BUFFER_SIZE
   #define LPC175X_ETH_TX_BUFFER_SIZE 1536
#elif (LPC175X_ETH_TX_BUFFER_SIZE != 1536)
   #error LPC175X_ETH_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef LPC175X_ETH_RX_BUFFER_COUNT
   #define LPC175X_ETH_RX_BUFFER_COUNT 4
#elif (LPC175X_ETH_RX_BUFFER_COUNT < 1)
   #error LPC175X_ETH_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef LPC175X_ETH_RX_BUFFER_SIZE
   #define LPC175X_ETH_RX_BUFFER_SIZE 1536
#elif (LPC175X_ETH_RX_BUFFER_SIZE != 1536)
   #error LPC175X_ETH_RX_BUFFER_SIZE parameter is not valid
#endif

//Interrupt priority grouping
#ifndef LPC175X_ETH_IRQ_PRIORITY_GROUPING
   #define LPC175X_ETH_IRQ_PRIORITY_GROUPING 2
#elif (LPC175X_ETH_IRQ_PRIORITY_GROUPING < 0)
   #error LPC175X_ETH_IRQ_PRIORITY_GROUPING parameter is not valid
#endif

//Ethernet interrupt group priority
#ifndef LPC175X_ETH_IRQ_GROUP_PRIORITY
   #define LPC175X_ETH_IRQ_GROUP_PRIORITY 24
#elif (LPC175X_ETH_IRQ_GROUP_PRIORITY < 0)
   #error LPC175X_ETH_IRQ_GROUP_PRIORITY parameter is not valid
#endif

//Ethernet interrupt subpriority
#ifndef LPC175X_ETH_IRQ_SUB_PRIORITY
   #define LPC175X_ETH_IRQ_SUB_PRIORITY 0
#elif (LPC175X_ETH_IRQ_SUB_PRIORITY < 0)
   #error LPC175X_ETH_IRQ_SUB_PRIORITY parameter is not valid
#endif

//MDC pin
#ifndef LPC175X_ETH_MDC_GPIO
   #define LPC175X_ETH_MDC_GPIO LPC_GPIO2
#endif

#ifndef LPC175X_ETH_MDC_MASK
   #define LPC175X_ETH_MDC_MASK (1 << 8)
#endif

//MDIO pin
#ifndef LPC175X_ETH_MDIO_GPIO
   #define LPC175X_ETH_MDIO_GPIO LPC_GPIO2
#endif

#ifndef LPC175X_ETH_MDIO_MASK
   #define LPC175X_ETH_MDIO_MASK (1 << 9)
#endif
...
extern const NicDriver lpc175xEthDriver;

//LPC175x Ethernet MAC related functions
