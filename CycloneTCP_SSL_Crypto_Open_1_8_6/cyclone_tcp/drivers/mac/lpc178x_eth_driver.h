...
#define _LPC178X_ETH_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef LPC178X_ETH_TX_BUFFER_COUNT
   #define LPC178X_ETH_TX_BUFFER_COUNT 3
#elif (LPC178X_ETH_TX_BUFFER_COUNT < 1)
   #error LPC178X_ETH_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef LPC178X_ETH_TX_BUFFER_SIZE
   #define LPC178X_ETH_TX_BUFFER_SIZE 1536
#elif (LPC178X_ETH_TX_BUFFER_SIZE != 1536)
   #error LPC178X_ETH_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef LPC178X_ETH_RX_BUFFER_COUNT
   #define LPC178X_ETH_RX_BUFFER_COUNT 6
#elif (LPC178X_ETH_RX_BUFFER_COUNT < 1)
   #error LPC178X_ETH_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef LPC178X_ETH_RX_BUFFER_SIZE
   #define LPC178X_ETH_RX_BUFFER_SIZE 1536
#elif (LPC178X_ETH_RX_BUFFER_SIZE != 1536)
   #error LPC178X_ETH_RX_BUFFER_SIZE parameter is not valid
#endif

//Interrupt priority grouping
#ifndef LPC178X_ETH_IRQ_PRIORITY_GROUPING
   #define LPC178X_ETH_IRQ_PRIORITY_GROUPING 2
#elif (LPC178X_ETH_IRQ_PRIORITY_GROUPING < 0)
   #error LPC178X_ETH_IRQ_PRIORITY_GROUPING parameter is not valid
#endif

//Ethernet interrupt group priority
#ifndef LPC178X_ETH_IRQ_GROUP_PRIORITY
   #define LPC178X_ETH_IRQ_GROUP_PRIORITY 24
#elif (LPC178X_ETH_IRQ_GROUP_PRIORITY < 0)
   #error LPC178X_ETH_IRQ_GROUP_PRIORITY parameter is not valid
#endif

//Ethernet interrupt subpriority
#ifndef LPC178X_ETH_IRQ_SUB_PRIORITY
   #define LPC178X_ETH_IRQ_SUB_PRIORITY 0
#elif (LPC178X_ETH_IRQ_SUB_PRIORITY < 0)
   #error LPC178X_ETH_IRQ_SUB_PRIORITY parameter is not valid
#endif
...
extern const NicDriver lpc178xEthDriver;

//LPC178x Ethernet MAC related functions
