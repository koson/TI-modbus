...
#define CPSW_ALE_CONTROL_R                HWREG(SOC_CPSW_ALE_REGS + CPSW_ALE_CONTROL)
...
#define CPSW_CPDMA_RX_CONTROL_R           HWREG(SOC_CPSW_CPDMA_REGS + CPSW_CPDMA_RX_CONTROL)
#define CPSW_CPDMA_RX_TEARDOWN_R          HWREG(SOC_CPSW_CPDMA_REGS + CPSW_CPDMA_RX_TEARDOWN)
#define CPSW_CPDMA_CPDMA_SOFT_RESET_R     HWREG(SOC_CPSW_CPDMA_REGS + CPSW_CPDMA_CPDMA_SOFT_RESET)
...
#define CPSW_CPDMA_CPDMA_IN_VECTOR_R      HWREG(SOC_CPSW_CPDMA_REGS + CPSW_CPDMA_CPDMA_IN_VECTOR)
#define CPSW_CPDMA_CPDMA_EOI_VECTOR_R     HWREG(SOC_CPSW_CPDMA_REGS + CPSW_CPDMA_CPDMA_EOI_VECTOR)
...
#define CPSW_CPDMA_TX_HDP_R(n)            HWREG(SOC_CPSW_CPDMA_REGS + CPSW_CPDMA_TX_HDP(n))
#define CPSW_CPDMA_RX_HDP_R(n)            HWREG(SOC_CPSW_CPDMA_REGS + CPSW_CPDMA_RX_HDP(n))
#define CPSW_CPDMA_TX_CP_R(n)             HWREG(SOC_CPSW_CPDMA_REGS + CPSW_CPDMA_TX_CP(n))
#define CPSW_CPDMA_RX_CP_R(n)             HWREG(SOC_CPSW_CPDMA_REGS + CPSW_CPDMA_RX_CP(n))

//CPSW_PORT registers
#define CPSW_PORT0_CONTROL_R              HWREG(SOC_CPSW_PORT_0_REGS + CPSW_PORT_CONTROL)
#define CPSW_PORT0_MAX_BLKS_R             HWREG(SOC_CPSW_PORT_0_REGS + CPSW_PORT_MAX_BLKS)
#define CPSW_PORT0_BLK_CNT_R              HWREG(SOC_CPSW_PORT_0_REGS + CPSW_PORT_BLK_CNT)
#define CPSW_PORT0_TX_IN_CTL_R            HWREG(SOC_CPSW_PORT_0_REGS + CPSW_PORT_TX_IN_CTL)
#define CPSW_PORT0_PORT_VLAN_R            HWREG(SOC_CPSW_PORT_0_REGS + CPSW_PORT_PORT_VLAN)
#define CPSW_PORT0_TX_PRI_MAP_R           HWREG(SOC_CPSW_PORT_0_REGS + CPSW_PORT_TX_PRI_MAP)
#define CPSW_PORT0_CPDMA_TX_PRI_MAP0_R    HWREG(SOC_CPSW_PORT_0_REGS + CPSW_PORT_CPDMA_TX_PRI_MAP0)
#define CPSW_PORT0_CPDMA_RX_CH_MAP0_R     HWREG(SOC_CPSW_PORT_0_REGS + CPSW_PORT_CPDMA_RX_CH_MAP0)
#define CPSW_PORT0_RX_DSCP_PRI_MAP_R(n)   HWREG(SOC_CPSW_PORT_0_REGS + CPSW_PORT_RX_DSCP_PRI_MAP(n))
#define CPSW_PORT0_TS_SEQ_MTYPE_R         HWREG(SOC_CPSW_PORT_0_REGS + CPSW_PORT_TS_SEQ_MTYPE)
#define CPSW_PORT0_SA_LO_R                HWREG(SOC_CPSW_PORT_0_REGS + CPSW_PORT_SA_LO)
#define CPSW_PORT0_SA_HI_R                HWREG(SOC_CPSW_PORT_0_REGS + CPSW_PORT_SA_HI)
#define CPSW_PORT0_SEND_PERCENT_R         HWREG(SOC_CPSW_PORT_0_REGS + CPSW_PORT_SEND_PERCENT)

#define CPSW_PORT1_CONTROL_R              HWREG(SOC_CPSW_PORT_1_REGS + CPSW_PORT_CONTROL)
#define CPSW_PORT1_MAX_BLKS_R             HWREG(SOC_CPSW_PORT_1_REGS + CPSW_PORT_MAX_BLKS)
#define CPSW_PORT1_BLK_CNT_R              HWREG(SOC_CPSW_PORT_1_REGS + CPSW_PORT_BLK_CNT)
#define CPSW_PORT1_TX_IN_CTL_R            HWREG(SOC_CPSW_PORT_1_REGS + CPSW_PORT_TX_IN_CTL)
#define CPSW_PORT1_PORT_VLAN_R            HWREG(SOC_CPSW_PORT_1_REGS + CPSW_PORT_PORT_VLAN)
#define CPSW_PORT1_TX_PRI_MAP_R           HWREG(SOC_CPSW_PORT_1_REGS + CPSW_PORT_TX_PRI_MAP)
#define CPSW_PORT1_CPDMA_TX_PRI_MAP0_R    HWREG(SOC_CPSW_PORT_1_REGS + CPSW_PORT_CPDMA_TX_PRI_MAP0)
#define CPSW_PORT1_CPDMA_RX_CH_MAP0_R     HWREG(SOC_CPSW_PORT_1_REGS + CPSW_PORT_CPDMA_RX_CH_MAP0)
#define CPSW_PORT1_RX_DSCP_PRI_MAP_R(n)   HWREG(SOC_CPSW_PORT_1_REGS + CPSW_PORT_RX_DSCP_PRI_MAP(n))
#define CPSW_PORT1_TS_SEQ_MTYPE_R         HWREG(SOC_CPSW_PORT_1_REGS + CPSW_PORT_TS_SEQ_MTYPE)
#define CPSW_PORT1_SA_LO_R                HWREG(SOC_CPSW_PORT_1_REGS + CPSW_PORT_SA_LO)
#define CPSW_PORT1_SA_HI_R                HWREG(SOC_CPSW_PORT_1_REGS + CPSW_PORT_SA_HI)
#define CPSW_PORT1_SEND_PERCENT_R         HWREG(SOC_CPSW_PORT_1_REGS + CPSW_PORT_SEND_PERCENT)

#define CPSW_PORT2_CONTROL_R              HWREG(SOC_CPSW_PORT_2_REGS + CPSW_PORT_CONTROL)
#define CPSW_PORT2_MAX_BLKS_R             HWREG(SOC_CPSW_PORT_2_REGS + CPSW_PORT_MAX_BLKS)
#define CPSW_PORT2_BLK_CNT_R              HWREG(SOC_CPSW_PORT_2_REGS + CPSW_PORT_BLK_CNT)
#define CPSW_PORT2_TX_IN_CTL_R            HWREG(SOC_CPSW_PORT_2_REGS + CPSW_PORT_TX_IN_CTL)
#define CPSW_PORT2_PORT_VLAN_R            HWREG(SOC_CPSW_PORT_2_REGS + CPSW_PORT_PORT_VLAN)
#define CPSW_PORT2_TX_PRI_MAP_R           HWREG(SOC_CPSW_PORT_2_REGS + CPSW_PORT_TX_PRI_MAP)
...
#define CPSW_PORT2_RX_DSCP_PRI_MAP_R(n)   HWREG(SOC_CPSW_PORT_2_REGS + CPSW_PORT_RX_DSCP_PRI_MAP(n))
#define CPSW_PORT2_TS_SEQ_MTYPE_R         HWREG(SOC_CPSW_PORT_2_REGS + CPSW_PORT_TS_SEQ_MTYPE)
#define CPSW_PORT2_SA_LO_R                HWREG(SOC_CPSW_PORT_2_REGS + CPSW_PORT_SA_LO)
#define CPSW_PORT2_SA_HI_R                HWREG(SOC_CPSW_PORT_2_REGS + CPSW_PORT_SA_HI)
#define CPSW_PORT2_SEND_PERCENT_R         HWREG(SOC_CPSW_PORT_2_REGS + CPSW_PORT_SEND_PERCENT)

//CPSW_SL registers
#define CPSW_SL1_IDVER_R                  HWREG(SOC_CPSW_SLIVER_1_REGS + CPSW_SL_IDVER)
#define CPSW_SL1_MACCONTROL_R             HWREG(SOC_CPSW_SLIVER_1_REGS + CPSW_SL_MACCONTROL)
#define CPSW_SL1_MACSTATUS_R              HWREG(SOC_CPSW_SLIVER_1_REGS + CPSW_SL_MACSTATUS)
...
#define CPSW_SL1_EMCONTROL_R              HWREG(SOC_CPSW_SLIVER_1_REGS + CPSW_SL_EMCONTROL)
...
#define CPSW_SL2_MACCONTROL_R             HWREG(SOC_CPSW_SLIVER_2_REGS + CPSW_SL_MACCONTROL)
#define CPSW_SL2_MACSTATUS_R              HWREG(SOC_CPSW_SLIVER_2_REGS + CPSW_SL_MACSTATUS)
...
#define CPSW_SL2_EMCONTROL_R              HWREG(SOC_CPSW_SLIVER_2_REGS + CPSW_SL_EMCONTROL)
...
#define CPSW_SS_CONTROL_R                 HWREG(SOC_CPSW_SS_REGS + CPSW_SS_CONTROL)
...
#define CPSW_SS_FLOW_CONTROL_R            HWREG(SOC_CPSW_SS_REGS + CPSW_SS_FLOW_CONTROL)
...
#define CPSW_WR_CONTROL_R                 HWREG(SOC_CPSW_WR_REGS + CPSW_WR_CONTROL)
#define CPSW_WR_INT_CONTROL_R             HWREG(SOC_CPSW_WR_REGS + CPSW_WR_INT_CONTROL)
...
#define MDIO_CONTROL_R                    HWREG(SOC_CPSW_MDIO_REGS + MDIO_CONTROL)
...
#define MDIO_USERACCESS0_R                HWREG(SOC_CPSW_MDIO_REGS + MDIO_USERACCESS0)
#define MDIO_USERPHYSEL0_R                HWREG(SOC_CPSW_MDIO_REGS + MDIO_USERPHYSEL0)
#define MDIO_USERACCESS1_R                HWREG(SOC_CPSW_MDIO_REGS + MDIO_USERACCESS1)
#define MDIO_USERPHYSEL1_R                HWREG(SOC_CPSW_MDIO_REGS + MDIO_USERPHYSEL1)
...
//ALE_PORTCTL register
#define CPSW_ALE_PORTCTL_PORT_STATE_DISABLED  0x00000000
#define CPSW_ALE_PORTCTL_PORT_STATE_BLOCKED   0x00000001
#define CPSW_ALE_PORTCTL_PORT_STATE_LEARN     0x00000002
#define CPSW_ALE_PORTCTL_PORT_STATE_FORWARD   0x00000003
