...
#define _LPC18XX_ETH_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef LPC18XX_ETH_TX_BUFFER_COUNT
   #define LPC18XX_ETH_TX_BUFFER_COUNT 3
#elif (LPC18XX_ETH_TX_BUFFER_COUNT < 1)
   #error LPC18XX_ETH_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef LPC18XX_ETH_TX_BUFFER_SIZE
   #define LPC18XX_ETH_TX_BUFFER_SIZE 1536
#elif (LPC18XX_ETH_TX_BUFFER_SIZE != 1536)
   #error LPC18XX_ETH_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef LPC18XX_ETH_RX_BUFFER_COUNT
   #define LPC18XX_ETH_RX_BUFFER_COUNT 6
#elif (LPC18XX_ETH_RX_BUFFER_COUNT < 1)
   #error LPC18XX_ETH_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef LPC18XX_ETH_RX_BUFFER_SIZE
   #define LPC18XX_ETH_RX_BUFFER_SIZE 1536
#elif (LPC18XX_ETH_RX_BUFFER_SIZE != 1536)
   #error LPC18XX_ETH_RX_BUFFER_SIZE parameter is not valid
#endif

//Interrupt priority grouping
#ifndef LPC18XX_ETH_IRQ_PRIORITY_GROUPING
   #define LPC18XX_ETH_IRQ_PRIORITY_GROUPING 4
#elif (LPC18XX_ETH_IRQ_PRIORITY_GROUPING < 0)
   #error LPC18XX_ETH_IRQ_PRIORITY_GROUPING parameter is not valid
#endif

//Ethernet interrupt group priority
#ifndef LPC18XX_ETH_IRQ_GROUP_PRIORITY
   #define LPC18XX_ETH_IRQ_GROUP_PRIORITY 6
#elif (LPC18XX_ETH_IRQ_GROUP_PRIORITY < 0)
   #error LPC18XX_ETH_IRQ_GROUP_PRIORITY parameter is not valid
#endif

//Ethernet interrupt subpriority
#ifndef LPC18XX_ETH_IRQ_SUB_PRIORITY
   #define LPC18XX_ETH_IRQ_SUB_PRIORITY 0
#elif (LPC18XX_ETH_IRQ_SUB_PRIORITY < 0)
   #error LPC18XX_ETH_IRQ_SUB_PRIORITY parameter is not valid
#endif
...
extern const NicDriver lpc18xxEthDriver;

//LPC18xx Ethernet MAC related functions
