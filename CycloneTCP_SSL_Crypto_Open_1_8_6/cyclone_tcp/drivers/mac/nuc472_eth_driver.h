...
#define _NUC472_ETH_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef NUC472_ETH_TX_BUFFER_COUNT
   #define NUC472_ETH_TX_BUFFER_COUNT 2
#elif (NUC472_ETH_TX_BUFFER_COUNT < 1)
   #error NUC472_ETH_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef NUC472_ETH_TX_BUFFER_SIZE
   #define NUC472_ETH_TX_BUFFER_SIZE 1536
#elif (NUC472_ETH_TX_BUFFER_SIZE != 1536)
   #error NUC472_ETH_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef NUC472_ETH_RX_BUFFER_COUNT
   #define NUC472_ETH_RX_BUFFER_COUNT 4
#elif (NUC472_ETH_RX_BUFFER_COUNT < 1)
   #error NUC472_ETH_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef NUC472_ETH_RX_BUFFER_SIZE
   #define NUC472_ETH_RX_BUFFER_SIZE 1536
#elif (NUC472_ETH_RX_BUFFER_SIZE != 1536)
   #error NUC472_ETH_RX_BUFFER_SIZE parameter is not valid
#endif

//Interrupt priority grouping
#ifndef NUC472_ETH_IRQ_PRIORITY_GROUPING
   #define NUC472_ETH_IRQ_PRIORITY_GROUPING 3
#elif (NUC472_ETH_IRQ_PRIORITY_GROUPING < 0)
   #error NUC472_ETH_IRQ_PRIORITY_GROUPING parameter is not valid
#endif

//Ethernet interrupt group priority
#ifndef NUC472_ETH_IRQ_GROUP_PRIORITY
   #define NUC472_ETH_IRQ_GROUP_PRIORITY 12
#elif (NUC472_ETH_IRQ_GROUP_PRIORITY < 0)
   #error NUC472_ETH_IRQ_GROUP_PRIORITY parameter is not valid
#endif

//Ethernet interrupt subpriority
#ifndef NUC472_ETH_IRQ_SUB_PRIORITY
   #define NUC472_ETH_IRQ_SUB_PRIORITY 0
#elif (NUC472_ETH_IRQ_SUB_PRIORITY < 0)
   #error NUC472_ETH_IRQ_SUB_PRIORITY parameter is not valid
#endif
...
extern const NicDriver nuc472EthDriver;

//NUC472 Ethernet MAC related functions
