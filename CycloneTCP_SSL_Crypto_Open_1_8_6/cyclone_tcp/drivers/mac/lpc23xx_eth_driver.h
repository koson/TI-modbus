...
#ifndef _LPC23XX_ETH_DRIVER_H
#define _LPC23XX_ETH_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef LPC23XX_ETH_TX_BUFFER_COUNT
   #define LPC23XX_ETH_TX_BUFFER_COUNT 2
#elif (LPC23XX_ETH_TX_BUFFER_COUNT < 1)
   #error LPC23XX_ETH_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef LPC23XX_ETH_TX_BUFFER_SIZE
   #define LPC23XX_ETH_TX_BUFFER_SIZE 1536
#elif (LPC23XX_ETH_TX_BUFFER_SIZE != 1536)
   #error LPC23XX_ETH_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef LPC23XX_ETH_RX_BUFFER_COUNT
   #define LPC23XX_ETH_RX_BUFFER_COUNT 4
#elif (LPC23XX_ETH_RX_BUFFER_COUNT < 1)
   #error LPC23XX_ETH_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef LPC23XX_ETH_RX_BUFFER_SIZE
   #define LPC23XX_ETH_RX_BUFFER_SIZE 1536
#elif (LPC23XX_ETH_RX_BUFFER_SIZE != 1536)
   #error LPC23XX_ETH_RX_BUFFER_SIZE parameter is not valid
#endif

//Ethernet interrupt priority
#ifndef LPC23XX_ETH_IRQ_PRIORITY
   #define LPC23XX_ETH_IRQ_PRIORITY 15
#elif (LPC23XX_ETH_IRQ_PRIORITY < 0)
   #error LPC23XX_ETH_IRQ_PRIORITY parameter is not valid
#endif
...
extern const NicDriver lpc23xxEthDriver;

//LPC23xx Ethernet MAC related functions
