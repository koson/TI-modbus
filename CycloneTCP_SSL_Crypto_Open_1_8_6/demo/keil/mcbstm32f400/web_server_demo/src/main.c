...
#if 1
   //Version 1.1 of the MCBSTM32F400 board uses an ST802RT1 Ethernet PHY
   netSetPhyDriver(interface, &st802rt1aPhyDriver);
#else
   //Version 1.2 of the MCBSTM32F400 board uses an KSZ8081 Ethernet PHY
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "MCBSTM32F400");
   }
