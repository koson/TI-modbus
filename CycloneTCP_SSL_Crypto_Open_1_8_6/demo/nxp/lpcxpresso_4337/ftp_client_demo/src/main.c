...
#define APP_MAC_ADDR "00-AB-CD-EF-43-37"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::4337"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::4337"
...
void ioInit(void)
{
   ...
   //Configure red LED
   LPC_SCU->SFSP6_11 = 0;
   LPC_GPIO_PORT->DIR[LED_R_PORT] |= LED_R_MASK;
   LPC_GPIO_PORT->SET[LED_R_PORT] = LED_R_MASK;

   //Configure green LED
   LPC_SCU->SFSP2_7 = 0;
   LPC_GPIO_PORT->DIR[LED_G_PORT] |= LED_G_MASK;
   LPC_GPIO_PORT->SET[LED_G_PORT] = LED_G_MASK;

   //Configure blue LED
   LPC_SCU->SFSP6_9 = 0;
   LPC_GPIO_PORT->DIR[LED_B_PORT] |= LED_B_MASK;
   LPC_GPIO_PORT->SET[LED_B_PORT] = LED_B_MASK;
...
void blinkTask(void *param)
{
   ...
   while(1)
   {
      LPC_GPIO_PORT->CLR[LED_R_PORT] = LED_R_MASK;
      osDelayTask(100);
      LPC_GPIO_PORT->SET[LED_R_PORT] = LED_R_MASK;
      osDelayTask(900);
   }
