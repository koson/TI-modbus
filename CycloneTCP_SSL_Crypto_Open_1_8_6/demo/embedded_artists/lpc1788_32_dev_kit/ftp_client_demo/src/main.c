...
#define APP_MAC_ADDR "00-AB-CD-EF-17-88"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::1788"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::1788"
...
void ioInit(void)
{
   ...
   //Configure joystick
   JOYSTICK_FIODIR &= ~(JOYSTICK_UP_MASK | JOYSTICK_DOWN_MASK |
      JOYSTICK_LEFT_MASK | JOYSTICK_RIGHT_MASK);

   //Configure LED3
   LED3_FIOSET = LED3_MASK;
   LED3_FIODIR |= LED3_MASK;

   //Configure LED4
   LED4_FIOSET = LED4_MASK;
   LED4_FIODIR |= LED4_MASK;
}
...
void userTask(void *param)
{
   ...
   {
      //SW6 button pressed?
      if(!(SW6_FIOPIN & SW6_MASK))
      {
         //FTP client test routine
         ftpClientTest();

         //Wait for the button to be released
         while(!(SW6_FIOPIN & SW6_MASK));
      }
...
int_t main(void)
{
   ...
   netSetDriver(interface, &lpc178xEthDriver);
