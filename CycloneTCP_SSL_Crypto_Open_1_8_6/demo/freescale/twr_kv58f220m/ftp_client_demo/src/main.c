...
#define APP_MAC_ADDR "00-AB-CD-EF-00-58"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::58"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::58"
...
void ioInit(void)
{
   ...
   //Configure SW4
   PORT_SW4->PCR[SW4_POS] = PORT_PCR_MUX(1) | PORT_PCR_PE_MASK | PORT_PCR_PS_MASK;
   GPIO_SW4->PDDR &= ~SW4_MASK;

   //Configure SW5
   PORT_SW5->PCR[SW5_POS] = PORT_PCR_MUX(1) | PORT_PCR_PE_MASK | PORT_PCR_PS_MASK;
   GPIO_SW5->PDDR &= ~SW5_MASK;
}
...
void userTask(void *param)
{
   ...
   {
      //SW4 button pressed?
      if(!(GPIO_SW4->PDIR & SW4_MASK))
      {
         //FTP client test routine
         ftpClientTest();

         //Wait for the SW4 button to be released
         while(!(GPIO_SW4->PDIR & SW4_MASK));
      }
...
int_t main(void)
{
   ...
   netSetDriver(interface, &mkv5xEthDriver);
