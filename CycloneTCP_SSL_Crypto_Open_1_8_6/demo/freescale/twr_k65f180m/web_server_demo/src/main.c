...
void ioInit(void)
{
   ...
   //Configure LED6
   PORT_LED6->PCR[LED6_POS] = PORT_PCR_MUX(1);
   GPIO_LED6->PDDR |= LED6_MASK;
   GPIO_LED6->PSOR |= LED6_MASK;

   //Configure LED7
   PORT_LED7->PCR[LED7_POS] = PORT_PCR_MUX(1);
   GPIO_LED7->PDDR |= LED7_MASK;
   GPIO_LED7->PSOR |= LED7_MASK;

   //Configure LED8
   PORT_LED8->PCR[LED8_POS] = PORT_PCR_MUX(1);
   GPIO_LED8->PDDR |= LED8_MASK;
   GPIO_LED8->PSOR |= LED8_MASK;

   //Configure LED9
   PORT_LED9->PCR[LED9_POS] = PORT_PCR_MUX(1);
   GPIO_LED9->PDDR |= LED9_MASK;
   GPIO_LED9->PSOR |= LED9_MASK;
