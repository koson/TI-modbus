...
#define APP_MAC_ADDR "00-AB-CD-EF-00-32"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::32"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::32"
...
{
   //Configure LED0
   AVR32_GPIO.port[LED0_PORT].gpers = 1 << LED0_POS;
   AVR32_GPIO.port[LED0_PORT].oders = 1 << LED0_POS;
   AVR32_GPIO.port[LED0_PORT].ovrs = 1 << LED0_POS;

   //Configure LED1
   AVR32_GPIO.port[LED1_PORT].gpers = 1 << LED1_POS;
   AVR32_GPIO.port[LED1_PORT].oders = 1 << LED1_POS;
   AVR32_GPIO.port[LED1_PORT].ovrs = 1 << LED1_POS;

   //Configure LED2
   AVR32_GPIO.port[LED2_PORT].gpers = 1 << LED2_POS;
   AVR32_GPIO.port[LED2_PORT].oders = 1 << LED2_POS;
   AVR32_GPIO.port[LED2_PORT].ovrs = 1 << LED2_POS;

   //Configure LED3
   AVR32_GPIO.port[LED3_PORT].gpers = 1 << LED3_POS;
   AVR32_GPIO.port[LED3_PORT].oders = 1 << LED3_POS;
   AVR32_GPIO.port[LED3_PORT].ovrs = 1 << LED3_POS;
}
...
int_t main(void)
{
   ...
   //Create user task
   task = osCreateTask("User Task", userTask, NULL, 850, OS_TASK_PRIORITY_NORMAL);
