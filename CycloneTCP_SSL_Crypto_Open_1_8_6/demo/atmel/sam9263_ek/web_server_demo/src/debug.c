...
{
   //Enable SYS and PIOC peripheral clocks
   AT91C_BASE_PMC->PMC_PCER = (1 << AT91C_ID_SYS) | (1 << AT91C_ID_PIOCDE);

   //Disable interrupts on DTXD and DRXD pins
   AT91C_BASE_PIOC->PIO_IDR = AT91C_PC31_DTXD | AT91C_PC30_DRXD;
   //No pull-up resistors
   AT91C_BASE_PIOC->PIO_PPUDR = AT91C_PC31_DTXD | AT91C_PC30_DRXD;
