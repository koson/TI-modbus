...
//RST pin (PA24)
#define CONF_WINC_RST_PIN     PIO_PA24
#define CONF_WINC_RST_PIO     PIOA
#define CONF_WINC_RST_ID_PIO  ID_PIOA

//CE pin (PA6)
#define CONF_WINC_CE_PIN      PIO_PA6
...
//IRQ pin (PA1)
#define CONF_WINC_IRQ_PIN     PIO_PA1
#define CONF_WINC_IRQ_PIO     PIOA
#define CONF_WINC_IRQ_ID_PIO  ID_PIOA

//SCK pin (PA14)
#define CONF_WINC_SCK_PIN     PIO_PA14A_SPCK

//MOSI pin (PA13)
#define CONF_WINC_MOSI_PIN    PIO_PA13A_MOSI

//MISO pin (PA12)
#define CONF_WINC_MISO_PIN    PIO_PA12A_MISO
