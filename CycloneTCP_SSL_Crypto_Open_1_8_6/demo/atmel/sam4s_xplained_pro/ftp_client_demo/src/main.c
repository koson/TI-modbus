...
#define APP_MAC_ADDR "00-AB-CD-EF-04-32"
...
void ioInit(void)
{
   ...
   //Configure EXT1_GPIO5 (PME) as an input
   ...
   //Configure EXT1_GPIO6 (RST) as an output
   PIOA->PIO_PER = PIO_PA25;
   PIOA->PIO_OER = PIO_PA25;

   //Reset KSZ8851 Ethernet controller
...
int_t main(void)
{
   ...
   netSetDriver(interface, &ksz8851Driver);
