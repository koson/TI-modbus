...
//CE pin (PD25)
#define CONF_WILC_CE_PIN      PIO_PD25
#define CONF_WILC_CE_PIO      PIOD
#define CONF_WILC_CE_ID_PIO   ID_PIOD
...
//CS pin (PB14)
#define CONF_WILC_CS_PIN      PIO_PB14
#define CONF_WILC_CS_PIO      PIOB
#define CONF_WILC_CS_ID_PIO   ID_PIOB

//IRQ pin (PA11)
#define CONF_WILC_IRQ_PIN     PIO_PA11
