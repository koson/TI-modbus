...
#include "os_port.h"
#include "core/net.h"
#include "drivers/mac/sama5d3_eth_driver.h"
...
#define APP_IF0_MAC_ADDR "00-AB-CD-EF-A5-D3"

#define APP_IF0_USE_DHCP ENABLED
...
#define APP_IF0_IPV6_LINK_LOCAL_ADDR "fe80::a5d3"
#define APP_IF0_IPV6_PREFIX "2001:db8::"
#define APP_IF0_IPV6_PREFIX_LENGTH 64
#define APP_IF0_IPV6_GLOBAL_ADDR "2001:db8::a5d3"
...
#define APP_IF1_MAC_ADDR "00-AB-CD-EF-A5-D4"

#define APP_IF1_USE_DHCP ENABLED
...
#define APP_IF1_IPV6_LINK_LOCAL_ADDR "fe80::a5d4"
#define APP_IF1_IPV6_PREFIX "2001:db8::"
#define APP_IF1_IPV6_PREFIX_LENGTH 64
#define APP_IF1_IPV6_GLOBAL_ADDR "2001:db8::a5d4"
...
int_t main(void)
{
   ...
   OsTask *task;
   MacAddr macAddr;
#if (APP_IF0_USE_DHCP == DISABLED || APP_IF1_USE_DHCP == DISABLED)
   Ipv4Addr ipv4Addr;
#endif
   ...
   netSetDriver(interface, &sama5d3GigabitEthDriver);
   ...
   //Set interface name
   netSetInterfaceName(interface, "eth1");
   //Set host name
   netSetHostname(interface, "WebServerDemo1");
   //Select the relevant network adapter
   netSetDriver(interface, &sama5d3EthDriver);
