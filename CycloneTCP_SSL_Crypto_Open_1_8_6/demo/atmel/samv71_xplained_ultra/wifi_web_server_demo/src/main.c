...
#define APP_IF0_MAC_ADDR "00-AB-CD-EF-71-21"
...
#define APP_IF0_IPV6_LINK_LOCAL_ADDR "fe80::7121:0"
...
#define APP_IF1_IPV6_LINK_LOCAL_ADDR "fe80::7121:1"
...
#define APP_IF2_IPV6_LINK_LOCAL_ADDR "fe80::7121:2"
#define APP_IF2_IPV6_PREFIX "fd00:1:2:3::"
#define APP_IF2_IPV6_PREFIX_LENGTH 64
#define APP_IF2_IPV6_GLOBAL_ADDR "fd00:1:2:3::7121:2"
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "SAMV71-Xplained-Ultra");
   }
