@echo off
path="C:\Program Files (x86)\SEGGER\JLink_V620\"
...
jlink.exe -speed 12000 -if JTAG -device R7S721031_DualSPI -CommanderScript load_flash_debug.jlink
goto END
...
jlink.exe -speed 12000 -if JTAG -device R7S721031_DualSPI -CommanderScript load_flash_release.jlink
goto END
