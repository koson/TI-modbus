...
#define APP_MAC_ADDR "00-AB-CD-EF-28-35"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::2835"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::2835"
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "TMDXCNCDH52C1");
   }
