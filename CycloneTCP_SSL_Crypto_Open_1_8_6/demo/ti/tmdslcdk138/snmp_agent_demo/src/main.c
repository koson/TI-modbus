...
void ioInit(void)
{
   ...
   //Configure D4 (GPIO6_13) as a GPIO
   ...
   //Configure D5 (GPIO6_12) as a GPIO
   temp = HWREG(SOC_SYSCFG_0_REGS + SYSCFG0_PINMUX(13)) &
   ...
   //Configure D6 (GPIO2_12) as a GPIO
   ...
   //Configure D7 (GPIO0_9) as a GPIO
