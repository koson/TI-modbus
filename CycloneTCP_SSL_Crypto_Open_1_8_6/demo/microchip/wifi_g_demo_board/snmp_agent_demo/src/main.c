...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::695"
#define APP_IPV6_PREFIX "fd00:1:2:3::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "fd00:1:2:3::695"
...
void ioInit(void)
{
   ...
   //Configure LED0 (RE0)as an output
   TRISECLR = LED0_MASK;
   LATECLR = LED0_MASK;

   //Configure LED1 (RF1) as an output
   TRISFCLR = LED1_MASK;
   LATFCLR = LED1_MASK;

   //Configure LED2 (RF0) as an output
   TRISFCLR = LED2_MASK;
   LATFCLR = LED2_MASK;

   //Configure SW0 (RD9) as an input
   TRISDSET = SW0_MASK;
}
