...
//SNMPv3 support
#define SNMP_V3_SUPPORT ENABLED
//MIB-II module support
#define MIB2_SUPPORT ENABLED

//Wi-Fi event hook
extern void mrf24wgEventHook(uint8_t eventType, uint32_t eventData);
#define MRF24WG_EVENT_HOOK(eventType, eventData) mrf24wgEventHook(eventType, eventData)
