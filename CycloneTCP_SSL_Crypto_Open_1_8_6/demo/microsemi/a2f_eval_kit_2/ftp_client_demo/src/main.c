...
#define APP_MAC_ADDR "00-AB-CD-EF-0A-2F"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::a2f"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::a2f"
...
int_t main(void)
{
   ...
   netSetDriver(interface, &a2fxxxm3EthDriver);
