...
#define TLS_RSA_PSK_SUPPORT ENABLED
//DHE_PSK key exchange support
#define TLS_DHE_PSK_SUPPORT ENABLED
//ECDHE_PSK key exchange support
#define TLS_ECDHE_PSK_SUPPORT ENABLED
