...
#define APP_MAC_ADDR "00-AB-CD-EF-09-12"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::912"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::912"
...
void systemInit(void)
{
   ...
   //Enable PLL and wait for the PLL to lock
   SCU_PLLCmd(ENABLE);
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "STR-E912");
   }
