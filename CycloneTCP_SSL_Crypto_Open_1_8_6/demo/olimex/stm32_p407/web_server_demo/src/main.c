...
void ioInit(void)
{
   ...
   RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA |
      RCC_AHB1Periph_GPIOC | RCC_AHB1Periph_GPIOF, ENABLE);
...
void adc3Init(void)
{
   ...
   //ADC3 regular channe10 configuration
...
void userTask(void *param)
{
   ...
   while(1)
   {
      ...
      //Get joystick state
      if(GPIO_ReadInputData(JOYSTICK_GPIO) & JOYSTICK_LEFT_PIN)
         joystickState = 1;
      else if(GPIO_ReadInputData(JOYSTICK_GPIO) & JOYSTICK_RIGHT_PIN)
         joystickState = 2;
      else if(GPIO_ReadInputData(JOYSTICK_GPIO) & JOYSTICK_UP_PIN)
         joystickState = 3;
      else if(GPIO_ReadInputData(JOYSTICK_GPIO) & JOYSTICK_DOWN_PIN)
         joystickState = 4;
      else
         joystickState = 0;
