...
#define APP_MAC_ADDR "00-AB-CD-EF-17-66"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::1766"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::1766"
...
void ioInit(void)
{
   ...
   //Configure joystick
   JOYSTICK_FIODIR &= ~(JOYSTICK_UP_MASK | JOYSTICK_DOWN_MASK | JOYSTICK_LEFT_MASK | JOYSTICK_RIGHT_MASK);
   JOYSTICK_CENTER_FDIR &= ~JOYSTICK_CENTER_MASK;
}
...
int_t main(void)
{
   ...
   netSetDriver(interface, &lpc176xEthDriver);
