...
copy ..\..\..\..\cyclone_tcp\mqtt\*.c src\cyclone_tcp\mqtt
copy ..\..\..\..\cyclone_tcp\web_socket\*.c src\cyclone_tcp\web_socket
...
copy ..\..\..\..\cyclone_tcp\mqtt\*.h src\cyclone_tcp\mqtt
