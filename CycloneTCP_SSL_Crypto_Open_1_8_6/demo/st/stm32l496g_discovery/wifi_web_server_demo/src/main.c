...
#define APP_IF0_IPV6_LINK_LOCAL_ADDR "fe80::496:1"
...
#define APP_IF1_IPV6_LINK_LOCAL_ADDR "fe80::496:2"
#define APP_IF1_IPV6_PREFIX "fd00:1:2:3::"
#define APP_IF1_IPV6_PREFIX_LENGTH 64
#define APP_IF1_IPV6_GLOBAL_ADDR "fd00:1:2:3::496:2"
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "STM32L496G-Discovery");
   }
