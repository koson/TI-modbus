...
#define STM32F7XX_ETH_MDIO_PIN  GPIO_PIN_6
#define STM32F7XX_ETH_MDIO_GPIO GPIOG
#define STM32F7XX_ETH_MDC_PIN   GPIO_PIN_7
#define STM32F7XX_ETH_MDC_GPIO  GPIOG
