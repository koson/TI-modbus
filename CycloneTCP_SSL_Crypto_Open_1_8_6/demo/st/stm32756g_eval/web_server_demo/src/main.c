...
#define APP_MAC_ADDR "00-AB-CD-EF-07-56"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::756"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::756"
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "STM32756G-EVAL");
   }
