...
#define APP_IF0_IPV6_LINK_LOCAL_ADDR "fe80::723:1"
...
#define APP_IF1_IPV6_LINK_LOCAL_ADDR "fe80::723:2"
#define APP_IF1_IPV6_PREFIX "fd00:1:2:3::"
#define APP_IF1_IPV6_PREFIX_LENGTH 64
#define APP_IF1_IPV6_GLOBAL_ADDR "fd00:1:2:3::723:2"
...
void ioInit(void)
{
   ...
   //Enable GPIOH and GPIOI clocks
   __HAL_RCC_GPIOH_CLK_ENABLE();
   __HAL_RCC_GPIOI_CLK_ENABLE();

   //Configure PMOD_SEL_0 (PH15) as an output
   ...
   //Configure PMOD_SEL_1 (PI10) as an output
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "STM32F723E-Discovery");
   }
