...
#define APP_IF0_MAC_ADDR "00-AB-CD-02-07-00"
...
#define APP_IF0_IPV6_LINK_LOCAL_ADDR "fe80::207:0"

//USB/RNDIS interface configuration
#define APP_IF1_MAC_ADDR "00-AB-CD-02-07-01"

#define APP_IF1_USE_DHCP_SERVER ENABLED
#define APP_IF1_IPV4_HOST_ADDR "192.168.9.1"
...
#define APP_IF1_IPV4_ADDR_RANGE_MIN "192.168.9.10"
#define APP_IF1_IPV4_ADDR_RANGE_MAX "192.168.9.99"

#define APP_IF1_USE_ROUTER_ADV ENABLED
#define APP_IF1_IPV6_LINK_LOCAL_ADDR "fe80::207:1"
#define APP_IF1_IPV6_PREFIX "fd00:1:2:3::"
#define APP_IF1_IPV6_PREFIX_LENGTH 64
#define APP_IF1_IPV6_GLOBAL_ADDR "fd00:1:2:3::207:1"
...
error_t usbRndisInterfaceInit(void);
...
int_t main(void)
{
   ...
   TRACE_INFO("\r\n");
   TRACE_INFO("********************************************\r\n");
   TRACE_INFO("*** CycloneTCP USB/RNDIS Web Server Demo ***\r\n");
   TRACE_INFO("********************************************\r\n");
   ...
   //Configure the second network interface (USB/RNDIS)
   usbRndisInterfaceInit();
...
/**
 * @brief USB/RNDIS interface initialization
 **/
...
error_t usbRndisInterfaceInit(void)
{
   ...
   //Set interface name
   netSetInterfaceName(interface, "usb1");
   //Set host name
   netSetHostname(interface, "WebServerDemo");
   //Select the relevant network adapter
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "Nucleo-F207ZG");
   }
