...
#define APP_IF0_MAC_ADDR "00-AB-CD-07-46-00"
...
#define APP_IF0_IPV6_LINK_LOCAL_ADDR "fe80::746:0"

//USB/RNDIS interface configuration
#define APP_IF1_MAC_ADDR "00-AB-CD-07-46-01"
...
#define APP_IF1_IPV6_LINK_LOCAL_ADDR "fe80::746:1"
#define APP_IF1_IPV6_PREFIX "fd00:1:2:3::"
#define APP_IF1_IPV6_PREFIX_LENGTH 64
#define APP_IF1_IPV6_GLOBAL_ADDR "fd00:1:2:3::746:1"
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "Nucleo-F746ZG");
   }
