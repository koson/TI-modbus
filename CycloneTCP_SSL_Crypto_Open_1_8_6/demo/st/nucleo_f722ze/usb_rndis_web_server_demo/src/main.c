...
#define APP_MAC_ADDR "00-00-00-00-07-22"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::722"
#define APP_IPV6_PREFIX "fd00:1:2:3::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "fd00:1:2:3::722"
...
int_t main(void)
{
   ...
   //Set interface name
   netSetInterfaceName(interface, "usb0");
   //Set host name
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "Nucleo-F722ZE");
   }
