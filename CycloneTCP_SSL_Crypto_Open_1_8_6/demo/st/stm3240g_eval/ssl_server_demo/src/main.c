...
int_t main(void)
{
   ...
   task = osCreateTask("SSL Server", sslServerTask, NULL, 600, OS_TASK_PRIORITY_NORMAL);
...
void sslServerTask(void *param)
{
   ...
   for(counter = 1; ; counter++)
   {
      ...
      task = osCreateTask("SSL Client", sslClientTask, clientSocket, 600, OS_TASK_PRIORITY_NORMAL);
