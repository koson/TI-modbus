...
#define STM32F7XX_ETH_MDIO_PIN  GPIO_PIN_12
#define STM32F7XX_ETH_MDIO_GPIO GPIOJ
#define STM32F7XX_ETH_MDC_PIN   GPIO_PIN_13
#define STM32F7XX_ETH_MDC_GPIO  GPIOJ
...
#define TCP_DEFAULT_TX_BUFFER_SIZE (1430*6)
//Default buffer size for reception
#define TCP_DEFAULT_RX_BUFFER_SIZE (1430*6)
...
#define HTTP_SERVER_BASIC_AUTH_SUPPORT ENABLED
