...
void I2C4_Event_IRQHandler         (void) __attribute__((weak, alias("Default_Handler")));
void I2C4_Error_IRQHandler         (void) __attribute__((weak, alias("Default_Handler")));

//Vector table
__attribute__((section(".isr_vector")))
const uint32_t vectorTable[121] =
{
   ...
   (uint32_t) I2C4_Event_IRQHandler,         //I2C 4 Event
   (uint32_t) I2C4_Error_IRQHandler,         //I2C 4 Error
};
