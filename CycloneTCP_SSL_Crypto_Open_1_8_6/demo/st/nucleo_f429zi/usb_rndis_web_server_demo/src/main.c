...
#define APP_IF0_MAC_ADDR "00-AB-CD-04-29-00"
...
#define APP_IF1_MAC_ADDR "00-AB-CD-04-29-01"
...
#define APP_IF1_IPV6_GLOBAL_ADDR "fd00:1:2:3::429:1"
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "Nucleo-F429ZI");
   }
