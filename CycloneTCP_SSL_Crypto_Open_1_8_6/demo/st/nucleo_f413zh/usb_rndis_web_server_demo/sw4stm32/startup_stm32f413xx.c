...
void UART10_IRQHandler             (void) __attribute__((weak, alias("Default_Handler")));
...
void DFSDM2_FLT0_IRQHandler        (void) __attribute__((weak, alias("Default_Handler")));
void DFSDM2_FLT1_IRQHandler        (void) __attribute__((weak, alias("Default_Handler")));
void DFSDM2_FLT2_IRQHandler        (void) __attribute__((weak, alias("Default_Handler")));
void DFSDM2_FLT3_IRQHandler        (void) __attribute__((weak, alias("Default_Handler")));

//Vector table
__attribute__((section(".isr_vector")))
const uint32_t vectorTable[118] =
{
   ...
   (uint32_t) TIM6_DAC_IRQHandler,           //TIM6, DAC1 and DAC2
   ...
   (uint32_t) UART9_IRQHandler,              //UART9
   (uint32_t) UART10_IRQHandler,             //UART10
   (uint32_t) 0,                             //Reserved
   (uint32_t) 0,                             //Reserved
   ...
   (uint32_t) DFSDM2_FLT0_IRQHandler,        //DFSDM2 Filter0
   (uint32_t) DFSDM2_FLT1_IRQHandler,        //DFSDM2 Filter1
   (uint32_t) DFSDM2_FLT2_IRQHandler,        //DFSDM2 Filter2
   (uint32_t) DFSDM2_FLT3_IRQHandler,        //DFSDM2 Filter3
};
