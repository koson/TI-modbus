...
#define APP_MAC_ADDR "00-AB-CD-EF-E2-CC"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::e2cc"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::e2cc"
...
{
   //Deactivate AN10
   bFM4_GPIO_ADE_AN10 = 0;
   //Configure red LED
   bFM4_GPIO_PFR1_PA = 0;
   bFM4_GPIO_DDR1_PA = 1;
   //Clear red LED
   bFM4_GPIO_PDOR1_PA = 1;

   //Deactivate AN18
   bFM4_GPIO_ADE_AN18 = 0;
   //Configure green LED
   bFM4_GPIO_PFRB_P2 = 0;
   bFM4_GPIO_DDRB_P2 = 1;
   //Clear green LED
   bFM4_GPIO_PDORB_P2 = 1;
   ...
   bFM4_GPIO_DDR1_P8 = 1;
   //Clear blue LED
   bFM4_GPIO_PDOR1_P8 = 1;

   //Configure yellow LED (Ethernet)
   bFM4_GPIO_PFR6_PE = 0;
   bFM4_GPIO_DDR6_PE = 1;
   //Clear yellow LED
   bFM4_GPIO_PDOR6_PE = 1;
...
int_t main(void)
{
   ...
   netSetDriver(interface, &fm4EthDriver);
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "SK-FM4176L-S6E2CC-ETH");
   }
